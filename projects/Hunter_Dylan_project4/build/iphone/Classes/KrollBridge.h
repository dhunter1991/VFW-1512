...
@interface Hunter_Dylan_project4Object : KrollCoverageObject {
#else
@interface Hunter_Dylan_project4Object : KrollObject {
#endif
@private
...
extern NSString * Hunter_Dylan_project4$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Hunter_Dylan_project4Object *_hunter_dylan_project4;
    KrollObject* console;
	BOOL shutdown;
