...
//@interface Hunter_Dylan_project4Object : NSObject
//@end

@interface Hunter_Dylan_project4Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Hunter_Dylan_project4Object class]])
		{
			for (NSString *key in [[(Hunter_Dylan_project4Object*)o modules] allKeys])
			{
