...
/**
 Base class for all Hunter_Dylan_project4 views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the Hunter_Dylan_project4 view hierarchy (such as wrapped iOS UIViews) was touched.
