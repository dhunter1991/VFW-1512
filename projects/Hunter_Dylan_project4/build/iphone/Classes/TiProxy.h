...
//Rare exceptions to indicate a bug in the _hunter_dylan_project4 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Hunter_Dylan_project4 proxies.
 */
