...
// in simulator we redefine to format for Hunter_Dylan_project4 Developer console
...
{\
	NSString * exceptionName = [@"org.hunter_dylan_project4." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.hunter_dylan_project4";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIHunter_Dylan_project4NativeItemNone = -1, 
	UIHunter_Dylan_project4NativeItemSpinner = -2,
	UIHunter_Dylan_project4NativeItemProgressBar = -3,
	
	UIHunter_Dylan_project4NativeItemSlider = -4,
	UIHunter_Dylan_project4NativeItemSwitch = -5,
	UIHunter_Dylan_project4NativeItemMultiButton = -6,
	UIHunter_Dylan_project4NativeItemSegmented = -7,
	
	UIHunter_Dylan_project4NativeItemTextView = -8,
	UIHunter_Dylan_project4NativeItemTextField = -9,
	UIHunter_Dylan_project4NativeItemSearchBar = -10,
	
	UIHunter_Dylan_project4NativeItemPicker = -11,
	UIHunter_Dylan_project4NativeItemDatePicker = -12,
	
	UIHunter_Dylan_project4NativeItemInfoLight = -13,
	UIHunter_Dylan_project4NativeItemInfoDark = -14,
	
	UIHunter_Dylan_project4NativeItemDisclosure = -15,
	
	UIHunter_Dylan_project4NativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Hunter_Dylan_project4 instances of
