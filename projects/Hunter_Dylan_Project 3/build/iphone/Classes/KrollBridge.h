...
@interface Hunter_Dylan_Project_3Object : KrollCoverageObject {
#else
@interface Hunter_Dylan_Project_3Object : KrollObject {
#endif
@private
...
extern NSString * Hunter_Dylan_Project_3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Hunter_Dylan_Project_3Object *_hunter_dylan_project_3;
    KrollObject* console;
	BOOL shutdown;
