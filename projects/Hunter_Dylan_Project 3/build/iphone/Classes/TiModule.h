...
/**
 The base class for all Hunter_Dylan_Project_3 modules
 */
...
/**
 Hunter_Dylan_Project_3 Platform calls this method on startup.
 */
-(void)startup;

/**
 Hunter_Dylan_Project_3 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Hunter_Dylan_Project_3 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Hunter_Dylan_Project_3 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Hunter_Dylan_Project_3 Platform calls this method on resume.
 @param sender The sender of the event.
 */
