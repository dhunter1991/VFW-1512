...
/**
 Base class for all Hunter_Dylan_Project_3 views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the Hunter_Dylan_Project_3 view hierarchy (such as wrapped iOS UIViews) was touched.
