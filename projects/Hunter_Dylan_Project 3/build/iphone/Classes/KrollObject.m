...
//@interface Hunter_Dylan_Project_3Object : NSObject
//@end

@interface Hunter_Dylan_Project_3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Hunter_Dylan_Project_3Object class]])
		{
			for (NSString *key in [[(Hunter_Dylan_Project_3Object*)o modules] allKeys])
			{
