...
// in simulator we redefine to format for Hunter_Dylan_Project_3 Developer console
...
{\
	NSString * exceptionName = [@"org.hunter_dylan_project_3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.hunter_dylan_project_3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIHunter_Dylan_Project_3NativeItemNone = -1, 
	UIHunter_Dylan_Project_3NativeItemSpinner = -2,
	UIHunter_Dylan_Project_3NativeItemProgressBar = -3,
	
	UIHunter_Dylan_Project_3NativeItemSlider = -4,
	UIHunter_Dylan_Project_3NativeItemSwitch = -5,
	UIHunter_Dylan_Project_3NativeItemMultiButton = -6,
	UIHunter_Dylan_Project_3NativeItemSegmented = -7,
	
	UIHunter_Dylan_Project_3NativeItemTextView = -8,
	UIHunter_Dylan_Project_3NativeItemTextField = -9,
	UIHunter_Dylan_Project_3NativeItemSearchBar = -10,
	
	UIHunter_Dylan_Project_3NativeItemPicker = -11,
	UIHunter_Dylan_Project_3NativeItemDatePicker = -12,
	
	UIHunter_Dylan_Project_3NativeItemInfoLight = -13,
	UIHunter_Dylan_Project_3NativeItemInfoDark = -14,
	
	UIHunter_Dylan_Project_3NativeItemDisclosure = -15,
	
	UIHunter_Dylan_Project_3NativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Hunter_Dylan_Project_3 instances of
