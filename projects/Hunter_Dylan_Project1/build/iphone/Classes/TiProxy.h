...
//Rare exceptions to indicate a bug in the _project1_dylan_hunter code (Eg, function that a subclass should have implemented)
...
/**
 The base class for project1_dylan_hunter proxies.
 */
