...
@interface project1_dylan_hunterObject : KrollCoverageObject {
#else
@interface project1_dylan_hunterObject : KrollObject {
#endif
@private
...
extern NSString * project1_dylan_hunter$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	project1_dylan_hunterObject *_project1_dylan_hunter;
    KrollObject* console;
	BOOL shutdown;
