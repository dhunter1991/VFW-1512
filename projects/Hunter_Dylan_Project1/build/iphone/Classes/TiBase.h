...
// in simulator we redefine to format for project1_dylan_hunter Developer console
...
{\
	NSString * exceptionName = [@"org.project1_dylan_hunter." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.project1_dylan_hunter";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIproject1_dylan_hunterNativeItemNone = -1, 
	UIproject1_dylan_hunterNativeItemSpinner = -2,
	UIproject1_dylan_hunterNativeItemProgressBar = -3,
	
	UIproject1_dylan_hunterNativeItemSlider = -4,
	UIproject1_dylan_hunterNativeItemSwitch = -5,
	UIproject1_dylan_hunterNativeItemMultiButton = -6,
	UIproject1_dylan_hunterNativeItemSegmented = -7,
	
	UIproject1_dylan_hunterNativeItemTextView = -8,
	UIproject1_dylan_hunterNativeItemTextField = -9,
	UIproject1_dylan_hunterNativeItemSearchBar = -10,
	
	UIproject1_dylan_hunterNativeItemPicker = -11,
	UIproject1_dylan_hunterNativeItemDatePicker = -12,
	
	UIproject1_dylan_hunterNativeItemInfoLight = -13,
	UIproject1_dylan_hunterNativeItemInfoDark = -14,
	
	UIproject1_dylan_hunterNativeItemDisclosure = -15,
	
	UIproject1_dylan_hunterNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all project1_dylan_hunter instances of
