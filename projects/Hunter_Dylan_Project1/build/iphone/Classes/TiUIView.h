...
/**
 Base class for all project1_dylan_hunter views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the project1_dylan_hunter view hierarchy (such as wrapped iOS UIViews) was touched.
