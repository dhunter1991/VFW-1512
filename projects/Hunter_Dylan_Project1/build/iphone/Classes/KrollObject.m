...
//@interface project1_dylan_hunterObject : NSObject
//@end

@interface project1_dylan_hunterObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[project1_dylan_hunterObject class]])
		{
			for (NSString *key in [[(project1_dylan_hunterObject*)o modules] allKeys])
			{
