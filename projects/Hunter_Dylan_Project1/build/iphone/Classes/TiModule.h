...
/**
 The base class for all project1_dylan_hunter modules
 */
...
/**
 project1_dylan_hunter Platform calls this method on startup.
 */
-(void)startup;

/**
 project1_dylan_hunter Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 project1_dylan_hunter Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 project1_dylan_hunter Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 project1_dylan_hunter Platform calls this method on resume.
 @param sender The sender of the event.
 */
