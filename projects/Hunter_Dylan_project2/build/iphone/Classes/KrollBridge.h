...
@interface Hunter_Dylan_project2Object : KrollCoverageObject {
#else
@interface Hunter_Dylan_project2Object : KrollObject {
#endif
@private
...
extern NSString * Hunter_Dylan_project2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Hunter_Dylan_project2Object *_hunter_dylan_project2;
    KrollObject* console;
	BOOL shutdown;
