...
//Rare exceptions to indicate a bug in the _hunter_dylan_project2 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Hunter_Dylan_project2 proxies.
 */
