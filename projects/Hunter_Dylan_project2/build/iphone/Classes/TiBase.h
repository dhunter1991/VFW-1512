...
// in simulator we redefine to format for Hunter_Dylan_project2 Developer console
...
{\
	NSString * exceptionName = [@"org.hunter_dylan_project2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.hunter_dylan_project2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIHunter_Dylan_project2NativeItemNone = -1, 
	UIHunter_Dylan_project2NativeItemSpinner = -2,
	UIHunter_Dylan_project2NativeItemProgressBar = -3,
	
	UIHunter_Dylan_project2NativeItemSlider = -4,
	UIHunter_Dylan_project2NativeItemSwitch = -5,
	UIHunter_Dylan_project2NativeItemMultiButton = -6,
	UIHunter_Dylan_project2NativeItemSegmented = -7,
	
	UIHunter_Dylan_project2NativeItemTextView = -8,
	UIHunter_Dylan_project2NativeItemTextField = -9,
	UIHunter_Dylan_project2NativeItemSearchBar = -10,
	
	UIHunter_Dylan_project2NativeItemPicker = -11,
	UIHunter_Dylan_project2NativeItemDatePicker = -12,
	
	UIHunter_Dylan_project2NativeItemInfoLight = -13,
	UIHunter_Dylan_project2NativeItemInfoDark = -14,
	
	UIHunter_Dylan_project2NativeItemDisclosure = -15,
	
	UIHunter_Dylan_project2NativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Hunter_Dylan_project2 instances of
