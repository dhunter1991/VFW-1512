...
//@interface Hunter_Dylan_project2Object : NSObject
//@end

@interface Hunter_Dylan_project2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Hunter_Dylan_project2Object class]])
		{
			for (NSString *key in [[(Hunter_Dylan_project2Object*)o modules] allKeys])
			{
